...
urlpatterns = [
    ...
    path('update_pays/<str:pk>/', views.update_pays, name="pays_update"),
    path('create_ville/', views.create_ville, name="ville_create"),
    path('list_ville/', views.list_ville, name="ville_list"),
    path('update_ville/<str:pk>/', views.update_ville, name="ville_update"),
    path('create_quartier/', views.create_quartier, name="quartier_create"),
    path('update_quartier/<str:pk>/', views.update_quartier, name="quartier_update"),
